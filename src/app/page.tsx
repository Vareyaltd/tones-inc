        ...
        <section id="home" className="relative h-screen min-h-[700px] flex flex-col justify-center overflow-hidden">
          <div className="absolute inset-0 z-0 bg-[#0A2540]">
            <AnimatePresence>
              ...
              >
                <Image
                  src={`/api/image?name=${heroImages[currentSlide]}`}
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative h-64 rounded-xl overflow-hidden col-span-2 shadow-lg">
                    <Image src="/api/image?name=tones_about_1_1780088082361.png" alt="Building" fill className="object-cover" unoptimized />
                  </div>
                  <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
                    <Image src="/api/image?name=tones_about_2_1780088099511.png" alt="Construction" fill className="object-cover" unoptimized />
                  </div>
                  <div className="relative h-48 rounded-xl overflow-hidden shadow-lg">
                    <Image src="/api/image?name=tones_about_3_1780088135004.png" alt="Solar" fill className="object-cover" unoptimized />
                  </div>
                </div>
                {/* Orange Box Overlay */}
        ...
        <section id="projects" className="py-24 bg-white overflow-hidden">
          <div className="container mx-auto px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Lagos Coastal Highway Development", img: "tones_projects_1_1780088032709.png", tag1: "Road Construction", tag2: "Lagos State", date: "2023 - Ongoing" },
                { title: "Abuja Smart Solar Grid", img: "tones_projects_2_1780088154405.png", tag1: "Energy", tag2: "Abuja", date: "2022 - Ongoing" },
                { title: "Port Harcourt Industrial Hub", img: "tones_projects_3_1780088175129.png", tag1: "Industrial", tag2: "Rivers State", date: "2021 - Ongoing" },
                { title: "Northern Water Infrastructure Initiative", img: "tones_projects_4_1780088206662.png", tag1: "Water Engineering", tag2: "Kano State", date: "2022 - Ongoing" }
              ].map((project, idx) => (
                <motion.div 
                  key={idx} 
                ...
                >
                  <Image 
                    src={`/api/image?name=${project.img}`} 
                    alt={project.title} 
                    fill 
        ...
        <section id="careers" className="py-0 bg-white overflow-hidden">
          <div className="container mx-auto px-6 md:px-12 mb-24">
            <div className="flex flex-col lg:flex-row bg-[#FAFAFA] rounded-2xl overflow-hidden border border-gray-100">
              ...
              >
                <Image 
                  src="/api/image?name=tones_careers_1780088014269.png" 
